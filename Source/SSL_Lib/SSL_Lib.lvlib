...
<Library LVVersion="13008000">
	...
	<Item Name="X509-Cert.lvclass" Type="LVClass" URL="../X509-Cert/X509-Cert.lvclass"/>
	<Item Name="SSL.lvclass" Type="LVClass" URL="../SSL/SSL.lvclass"/>
	<Item Name="BIO.lvclass" Type="LVClass" URL="../BIO/BIO.lvclass"/>
	<Item Name="SSL-Context.lvclass" Type="LVClass" URL="../SSL-Context/SSL-Context.lvclass"/>
	<Item Name="SSL-Lib.lvclass" Type="LVClass" URL="../SSL-Lib/SSL-Lib.lvclass"/>
</Library>
